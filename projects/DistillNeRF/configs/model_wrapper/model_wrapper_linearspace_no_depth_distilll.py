...
model = dict(
    ...
    model_yaml_path="projects/DistillNeRF/configs/models/model_linearspace.yaml",
...
checkpoint_config = dict(interval=1100, by_epoch=False, max_keep_ckpts=5)
