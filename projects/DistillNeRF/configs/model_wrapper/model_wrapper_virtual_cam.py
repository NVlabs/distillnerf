_base_ = [
    ...
    "../datasets/dataset_config_virtual_cam.py",
]
...
model = dict(
    ...
    model_yaml_path="projects/DistillNeRF/configs/models/model.yaml",
...
checkpoint_config = dict(interval=700, by_epoch=False, max_keep_ckpts=5)
