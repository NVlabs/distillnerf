_base_ = [
    ...
    "../datasets/dataset_config_400_224_dino.py",
]
...
model = dict(
    ...
    model_yaml_path="projects/DistillNeRF/configs/models/model_400_224_foundation_feature.yaml",
    ...
    render_foundation_model_feat='dino'
)
