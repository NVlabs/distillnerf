...
desired_input_img_size = (144, 216)
# desired_input_img_size = (228, 128)
...
dataset_type = "WaymoMultiModalDatasetV2"
data_root = "data/waymo/kitti_format/"
data_split = "emernerf_notr"
...
train_pipeline = [
    ...
    dict(type="LoadDepthImagesFromFilesWaymo",
    ...
    dict(
        ...
        transforms=[
            dict(type="Resize", img_scale=desired_input_img_size, keep_ratio=True),
...
data = dict(
    ...
    train=dict(
        ...
        # ann_file_3d=data_root + "waymo_infos_train.pkl",
        # ann_file_2d=data_root + "waymo_infos_train_mono3d.coco.json",
        split=data_split,
    ...
    val=dict(
        ...
        # ann_file_3d=data_root + "waymo_infos_val.pkl",
        # ann_file_2d=data_root + "waymo_infos_val_mono3d.coco.json",
        split=data_split,
